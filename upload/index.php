    ...
    if ($is_filtered) {
        ...
        $display_cars = [
            [
                ...
                'body_type' => 'Coupe', 
                'car_condition' => 'New', 
                'image' => 'assets/uploads/698c0444cfd50_BMW_M4_.jpg', 
...
<head>
    ...
    <style>
        :root {
            ...
            --c-text: #111111;
            --c-text-muted: #666666;
            --c-accent: #b8860b; /* Dark Goldenrod */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; outline: none; }
        ...
        .btn:hover { color: var(--c-bg); border-color: var(--c-text); }
        ...
        nav:not(.scrolled) .btn-primary { background: #ffffff; color: #000000; border-color: #ffffff; }
        nav:not(.scrolled) .btn-primary:hover { background: transparent; color: #000000; }
        ...
        .about-image::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(145deg, rgba(184,134,11,0.2) 0%, rgba(0,0,0,0) 70%);
            pointer-events: none;
        }
...
<body>
                ...
                <div class="search-form-wrapper">
                    <form method="GET" action="index.php#collection" class="grid search-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
                        <div class="form-group">
                            ...
                            <select name="make" style="width: 100%; padding: 1rem; background: var(--c-bg); color: var(--c-text); border: 1px solid var(--c-border); text-transform: uppercase;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="min_price" style="width: 100%; padding: 1rem; background: var(--c-bg); color: var(--c-text); border: 1px solid var(--c-border);">
                        ...
                        <div class="form-group">
                            ...
                            <select name="max_price" style="width: 100%; padding: 1rem; background: var(--c-bg); color: var(--c-text); border: 1px solid var(--c-border);">
                                <option value="">Any</option>
    ...
    <div class="content-after-hero">
        ...
        <section class="section stats-section" id="stats">
            <div class="container grid" style="grid-template-columns: repeat(4, 1fr);">
                <div class="stat-item" data-aos="fade-up" data-aos-delay="0">
                    <span class="text-display" style="font-size: 3rem; display: block;">150+</span>
                ...
                <div class="stat-item" data-aos="fade-up" data-aos-delay="100">
                    <span class="text-display" style="font-size: 3rem; display: block;">12</span>
                ...
                <div class="stat-item" data-aos="fade-up" data-aos-delay="200">
                    <span class="text-display" style="font-size: 3rem; display: block;">24/7</span>
                ...
                <div class="stat-item" data-aos="fade-up" data-aos-delay="300">
                    <span class="text-display" style="font-size: 3rem; display: block;">$500M+</span>
        ...
        <section class="brands-marquee">
            <div class="marquee-track">
                <?php for ($i = 0; $i < 2; $i++): ?>
                    <?php foreach ($brands as $b): ?>
                    <span class="text-display" style="font-size: 4rem; opacity: 0.3; color: transparent; -webkit-text-stroke: 1px var(--c-text); padding: 0 2rem;"><?php echo strtoupper($b); ?></span>
                    <?php endforeach; ?>
                <?php endfor; ?>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                    <div class="service-card" data-aos="fade-up" data-aos-delay="0">
                        <i class="fas fa-search" style="font-size: 2.5rem; color: var(--c-accent); margin-bottom: 1.5rem;"></i>
                    ...
                    <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                        <i class="fas fa-file-contract" style="font-size: 2.5rem; color: var(--c-accent); margin-bottom: 1.5rem;"></i>
                    ...
                    <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                        <i class="fas fa-truck-plane" style="font-size: 2.5rem; color: var(--c-accent); margin-bottom: 1.5rem;"></i>
    ...
    <!-- FOOTER - UPDATED WITH CHANGES -->
    <footer>
        <div class="container">
            <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 4rem; margin-bottom: 4rem;">
                <div>
                    <a href="index.php" class="logo" style="display: block; margin-bottom: 1.5rem; color: #ffffff !important;">AUTOELITE</a>
                    <p style="color: #999999; font-size: 0.9rem; max-width: 300px;">
                        The world's premier destination for acquiring verified, investment-grade automotive assets.
                    </p>
                </div>
                <div>
                    <h4>Services</h4>
                    <ul style="display: grid; gap: 0.8rem; color: #ffffff; font-size: 0.9rem;">
                        <li><a href="inspection.php" style="color: #ffffff !important;">Inspection</a></li>
                        <li><a href="warranty.php" style="color: #ffffff !important;">Warranty</a></li>
                        <li><a href="financing.php" style="color: #ffffff !important;">Financing</a></li>
                    </ul>
                </div>
                <div>
                    <h4>Social</h4>
                    <ul style="display: grid; gap: 0.8rem; color: #ffffff; font-size: 0.9rem;">
                        <li><a href="#" style="color: #ffffff !important;">Instagram</a></li>
                        <li><a href="#" style="color: #ffffff !important;">Facebook</a></li>
                        <li><a href="#" style="color: #ffffff !important;">Twitter</a></li>
                        <li><a href="#" style="color: #ffffff !important;">YouTube</a></li>
                    </ul>
                </div>
                <div>
                    <h4>Main</h4>
                    <ul style="display: grid; gap: 0.8rem; color: #ffffff; font-size: 0.9rem;">
                        ...
                        <li><a href="inventory.php" style="color: #ffffff !important;">Inventory</a></li>
                        <li><a href="about.php" style="color: #ffffff !important;">About</a></li>
                        <li><a href="contact.php" style="color: #ffffff !important;">Contact</a></li>
                    </ul>
                </div>
            </div>
            
            <div class="flex-between" style="padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.05); color: #999999; font-size: 0.8rem;">
                <span>&copy; 2026 AutoElite Motors. All rights reserved.</span>
                <div class="flex" style="gap: 1.5rem;">
                    <a href="#" style="color: #999999 !important;">Privacy</a>
                    <a href="#" style="color: #999999 !important;">Terms</a>
                    <a href="#" style="color: #999999 !important;">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
