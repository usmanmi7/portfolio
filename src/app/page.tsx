      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-base md:text-lg text-white/30 mb-12 max-w-sm">
            ...
            <div className="space-y-5">
              ...
              <a href="mailto:Webworks456@gmail.com" className="flex items-start gap-4 group">
                ...
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-white/20 block mb-1">Email</span>
                  <span className="text-[0.975rem] text-white/40 group-hover:text-white/60 transition-colors">Webworks456@gmail.com</span>
                </div>
              </a>
...
function Footer() {
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative py-20 md:py-32 border-t border-white/[0.04]">
        ...
        <div className="relative z-10 text-center select-none">
          ...
          <p className="text-[0.975rem] text-white/15 uppercase tracking-[0.3em] mt-4">
      ...
      <div className="border-t border-white/[0.04] px-6 md:px-10 py-16 md:py-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-[0.975rem] text-white/30 leading-relaxed max-w-xs mb-6">
              ...
              <div className="flex items-center gap-4">
                {SOCIAL_LINKS.map((s) => (
                  <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                    className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-white/20 hover:text-[#ff6b35] hover:border-[#ff6b35]/20 transition-all"
                    aria-label={s.label}
                  >
                    {s.label === "WhatsApp" && (
            ...
            <div className="lg:col-span-2">
              <h4 className="text-xs text-white/40 uppercase tracking-widest mb-5 font-medium">Navigation</h4>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-[0.975rem] text-white/25 hover:text-[#ff6b35] transition-colors duration-300"
                    >
                      {link.label}
                    </a>
                  </li>
            ...
            <div className="lg:col-span-3">
              <h4 className="text-xs text-white/40 uppercase tracking-widest mb-5 font-medium">Services</h4>
              <ul className="space-y-3">
                {[
                  "Website Design",
                  "Web Development",
            ...
            <div className="lg:col-span-3">
              <h4 className="text-xs text-white/40 uppercase tracking-widest mb-5 font-medium">Get in Touch</h4>
              <ul className="space-y-4">
                <li>
                  <p className="text-[0.975rem] text-white/25">Email</p>
                  <a
                    href="mailto:Webworks456@gmail.com"
                    className="text-[0.975rem] text-white/50 hover:text-[#ff6b35] transition-colors duration-300"
                  >
                    Webworks456@gmail.com
                  </a>
                </li>
                <li>
                  <p className="text-[0.975rem] text-white/25">WhatsApp</p>
                  <a
                ...
                <li>
                  <p className="text-[0.975rem] text-white/25">Location</p>
                  <p className="text-[0.975rem] text-white/40">Colombo, Sri Lanka</p>
                </li>
              </ul>
